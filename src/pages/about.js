  ...
  return (
    <div className=" mx-auto max-w-5xl px-4 py-8">
      ...
      <p className="mb-4">
        ...
        well as images into URLs that can be easily shared and accessed online.
      </p>
      <p className="mb-4">
      ...
      <p className="mb-4">
        ...
        sharing and accessing files online. Whether you need to share important
        documents with colleagues, present slideshows, or showcase images, our
        project provides a hassle-free solution.
      </p>
      <p className="mb-4">
        To use our service, simply navigate to the homepage and select the file
        you want to convert. After the file is uploaded and processed, you will
        receive a live URL that you can share with others. The converted file
        can then be accessed directly through the URL, eliminating the need for
        recipients to download and open files locally.
      </p>
      <p>
